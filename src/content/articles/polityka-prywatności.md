...
description: "Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod
  adresem url: www.360biuro.pl"
date: 2026-05-19T17:19:00.000+02:00
---
## **1. Informacje ogólne**
...
7. Prowadzenie systemu komentarzy
8. Prowadzenie rozmów typu chat online
9. Wyświetlanie ogłoszeń użytkowników
10. Obsługa zapytań przez formularz
11. Realizacja zamówionych usług
12. Windykacja należności
13. Prezentacja oferty lub informacji
14. Serwis realizuje funkcje pozyskiwania informacji o użytkownikach i ich zachowaniu w następujący sposób:
15. Poprzez dobrowolnie wprowadzone w formularzach dane, które zostają wprowadzone do systemów Operatora.
16. Poprzez zapisywanie w urządzeniach końcowych plików cookie (tzw. „ciasteczka”).
...
3. zasoby określone identyfikatorem URL (adresy żądanych zasobów – stron, plików),
...
11. informacje diagnostyczne związane z procesem samodzielnego zamawiania usług poprzez rejestratory na stronie,
12. informacje związane z obsługą poczty elektronicznej kierowanej do Operatora oraz wysyłanej przez Operatora.
13. Serwis może przetwarzać dane zawarte w przesłanych dokumentach księgowych w firmach: Amazon i OpenAI.
14. Serwis wykorzystuje do komunikacji e-mail profesjonalne usługi dedykowane przedsiębiorstowom firm Google i Scaleway.
15. Wszystkie usługi informatyczne świadczone przez ww. dostawców realizowane są zgodnie z deklaracjami dostawców i prawem Unii Europejskiej na terenie wewnątrzunijnym, bez przesyłania danych poza obszar UE.
16. Serwis przechowuje przesłane dokumenty księgowe i inne dokumenty na własnych serwerach na terenie Polski z zachowaniem ogólnie przyjętych norm bezpieczeństwa.
...
6. Twoje dane osobowe przetwarzane przez Administratora nie dłużej, niż jest to konieczne do wykonania związanych z nimi czynności określonych osobnymi przepisami (np. o prowadzeniu rachunkowości). W odniesieniu do danych marketingowych dane nie będą przetwarzane dłużej niż przez 3 lata.
7. Przysługuje Ci prawo żądania od Administratora:
8. dostępu do danych osobowych Ciebie dotyczących,
9. ich sprostowania,
10. usunięcia,
11. ograniczenia przetwarzania,
12. oraz przenoszenia danych.
...
15. Podanie danych osobowych jest dobrowolne, lecz niezbędne do obsługi Serwisu.
16. W stosunku do Ciebie mogą być podejmowane czynności polegające na zautomatyzowanym podejmowaniu decyzji, w tym profilowaniu w celu świadczenia usług w ramach zawartej umowy oraz w celu prowadzenia przez Administratora marketingu bezpośredniego.
17. Dane osobowe nie są przekazywane od krajów trzecich w rozumieniu przepisów o ochronie danych osobowych. Oznacza to, że nie przesyłamy ich poza teren Unii Europejskiej.
